...
// Active class on selected menu item
// Link hit closes mobile menu
...
for (let i = 0; i < links.length; i++) {
  links[i].addEventListener('click', () => {
    ...
    if (mobileMenu.classList.contains('show')) {
      setTimeout(() => { mobileMenu.classList.toggle('show')}, 240)
    }
  })
}

// AnchorJS - v4.3.0 - 2020-10-21 https://www.bryanbraun.com/anchorjs/ Copyright (c) 2020 Bryan Braun; Licensed MIT
...
// Load highlight.js loaded in separate file
